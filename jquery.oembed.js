...
(function ($) {
    ...
    $.fn.oembed.providers = [
        ...
        //Video
        new $.fn.oembed.OEmbedProvider("youtube", "video", ["youtube\\.com/watch.+v=[\\w-]+&?", "youtu\\.be/[\\w-]+", "youtube.com/embed"], '//www.youtube.com/embed/$1?wmode=transparent&$2', {
            templateRegex: /.*(?:v\=|be\/|embed\/)([^\?&]+)(?:[\?&](.*))?$/, embedtag: {tag: 'iframe', width: '425', height: '349'}
        }),
